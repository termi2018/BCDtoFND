...
set_property -dict { PACKAGE_PIN U1   IOSTANDARD LVCMOS33 } [get_ports {i_digitSelec[0] }]; #IO_L3N_T0_DQS_34           ,Sch=SW13
set_property -dict { PACKAGE_PIN T1   IOSTANDARD LVCMOS33 } [get_ports {i_digitSelec[1] }]; #IO_L3P_T0_DQS_34           ,Sch=SW14
...
# set_property -dict { PACKAGE_PIN N3   IOSTANDARD LVCMOS33 } [get_ports { i_digitSelect[1] }]; #IO_L12P_T1_MRCC_35           ,Sch=LED13
# set_property -dict { PACKAGE_PIN P1   IOSTANDARD LVCMOS33 } [get_ports { i_digitSelect[0] }]; #IO_L19N_T3_VREF_35           ,Sch=LED14
# set_property -dict { PACKAGE_PIN L1   IOSTANDARD LVCMOS33 } [get_ports {  }]; #IO_L6N_T0_VREF_35            ,Sch=LED15
